defmodule BreadWeb.Telemetry do
  use Supervisor
  ...
  def metrics do
    [
      ...
      summary("bread.repo.query.total_time", unit: {:native, :millisecond}),
      summary("bread.repo.query.decode_time", unit: {:native, :millisecond}),
      summary("bread.repo.query.query_time", unit: {:native, :millisecond}),
      summary("bread.repo.query.queue_time", unit: {:native, :millisecond}),
      summary("bread.repo.query.idle_time", unit: {:native, :millisecond}),
